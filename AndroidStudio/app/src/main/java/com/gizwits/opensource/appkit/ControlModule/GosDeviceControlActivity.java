...
public class GosDeviceControlActivity extends GosControlModuleBaseActivity
	...
	private Switch sw_bool_Examination;
	private Switch sw_bool_Deferred;
	private Spinner sp_enum_Classroom;
	private Spinner sp_enum_Lecture;
	private TextView tv_data_Students;
	...
	private void initView() {
		...
		sw_bool_Examination = (Switch) findViewById(R.id.sw_bool_Examination);
		sw_bool_Deferred = (Switch) findViewById(R.id.sw_bool_Deferred);
		sp_enum_Classroom = (Spinner) findViewById(R.id.sp_enum_Classroom);
		sp_enum_Lecture = (Spinner) findViewById(R.id.sp_enum_Lecture);
		tv_data_Students = (TextView) findViewById(R.id.tv_data_Students);
	}

	private void initEvent() {

		sw_bool_Examination.setOnClickListener(this);
		sw_bool_Deferred.setOnClickListener(this);
		sp_enum_Classroom.setSelection(0, false);
		sp_enum_Classroom.setOnItemSelectedListener(new OnItemSelectedListener() {

			@Override
			public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {

				if (position != data_Classroom) {
					sendCommand(KEY_CLASSROOM, position);
					data_Classroom = position;
				}
			}
		...
		sp_enum_Lecture.setSelection(0, false);
		sp_enum_Lecture.setOnItemSelectedListener(new OnItemSelectedListener() {

			@Override
			public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {

				if (position != data_Lecture) {
					sendCommand(KEY_LECTURE, position);
					data_Lecture = position;
				}
			}
	...
	public void onClick(View v) {
		switch (v.getId()) {
		case R.id.sw_bool_Examination:
			sendCommand(KEY_EXAMINATION, sw_bool_Examination.isChecked());
			break;
		case R.id.sw_bool_Deferred:
			sendCommand(KEY_DEFERRED, sw_bool_Deferred.isChecked());
			break;
		default:
			break;
		}
	...
	protected void updateUI() {
		...
		sw_bool_Examination.setChecked(data_Examination);
		sw_bool_Deferred.setChecked(data_Deferred);
		sp_enum_Classroom.setSelection(data_Classroom, true);
		sp_enum_Lecture.setSelection(data_Lecture, true);
		tv_data_Students.setText(data_Students+"");
