...
* @{
*/
#define PRODUCT_KEY "8de95648f25f46ad862d027b3f13f545"
/**@} */
/**@name Product Secret  
* @{
*/
#define PRODUCT_SECRET "76f705fc54804a7495905b19f8053ae8"
...
* @{
*/
#define Examination_BYTEOFFSET                    0
#define Examination_BITOFFSET                     0
#define Examination_LEN                           1
#define Deferred_BYTEOFFSET                    0
#define Deferred_BITOFFSET                     1
#define Deferred_LEN                           1
#define Classroom_BYTEOFFSET                    0
#define Classroom_BITOFFSET                     2
#define Classroom_LEN                           3
#define Lecture_BYTEOFFSET                    0
#define Lecture_BITOFFSET                     5
#define Lecture_LEN                           3

#define Students_RATIO                         1
#define Students_ADDITION                      0
#define Students_MIN                           0
#define Students_MAX                           500
/**@} */
...
typedef enum
{
    Classroom_VALUE0 = 0,//None
    Classroom_VALUE1 = 1,//DML307
    Classroom_VALUE2 = 2,//DML308
    Classroom_VALUE3 = 3,//DML309
    Classroom_VALUE4 = 4,//DML310
    Classroom_VALUE5 = 5,//DML311
    Classroom_VALUE6 = 6,//DML312
    Classroom_VALUE7 = 7,//DML313
    Classroom_VALUE_MAX,
} Classroom_ENUM_T;
typedef enum
{
    Lecture_VALUE0 = 0,//None
    Lecture_VALUE1 = 1,//DML307
    Lecture_VALUE2 = 2,//DML308
    Lecture_VALUE3 = 3,//DML309
    Lecture_VALUE4 = 4,//DML310
    Lecture_VALUE5 = 5,//DML311
    Lecture_VALUE6 = 6,//DML312
    Lecture_VALUE7 = 7,//DML313
    Lecture_VALUE_MAX,
} Lecture_ENUM_T;
...
typedef struct {
  bool valueExamination;
  bool valueDeferred;
  uint32_t valueClassroom;
  uint32_t valueLecture;
  uint32_t valueStudents;
} dataPoint_t;


/** Corresponding to the protocol "4.10 WiFi module control device" in the flag " attr_flags" */ 
typedef struct {
  uint8_t flagExamination:1;
  uint8_t flagDeferred:1;
  uint8_t flagClassroom:1;
  uint8_t flagLecture:1;
} attrFlags_t;
